...
static int _cffi_const_sprintf(PyObject *lib)
{
  PyObject *o;
  int res;
  int(* i)(char *, char const *, ...);
  i = (sprintf);
  o = _cffi_from_c_pointer((char *)i, _cffi_type(16));
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "sprintf", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_AF_INET(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_sprintf(lib);
}
...
PyMODINIT_FUNC
PyInit__cffi__x59c0cf5ex844baa21(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x59c0cf5ex844baa21(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x59c0cf5ex844baa21", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
